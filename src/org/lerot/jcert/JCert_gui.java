...
public class JCert_gui extends JFrame
{
	...
	public static void main(String[] args)
	{
		...
		;
		JCert_gui mframe = new JCert_gui(200, 200, d.width - 400,
				d.height - 400);
	...
	public JCert_gui(int x, int y, int w, int h)
	{
		super("CERTIFICATES");
		...
		selectCard("Messages");
		JCert_gui.messagepanel.display(mymessage);
