...
import org.lerot.jcert.DisplayObject;
import org.lerot.jcert.JCert_gui;
import org.lerot.jcert.hgroup;
import org.lerot.jcert.jcertObject;
				...
				if (cll instanceof DisplayObject) {
					...
					if (col == 0 && obtype != null && rowcount > 1) {
						Popup pp = new Popup(obtype + ":" + datarow,
								JCert_gui.certificateframeloaderpanel);
