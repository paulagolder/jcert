...
import org.lerot.jcert.layout.PLabel;
import org.lerot.jcert.layout.TablePanel;
...
public abstract class DisplayObject extends jcertObject
{
	...
	public void formatComponent(JComponent apanel)
	{
		...
		if (fontsize > 0) {
			apanel.setFont(new Font(JCert_gui.defaultfontname, Font.PLAIN,
					fontsize));
		} else
			apanel.setFont(JCert_gui.defaultfont);
