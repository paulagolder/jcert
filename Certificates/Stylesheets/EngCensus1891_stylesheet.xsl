  ...
  <html>
     <STYLE type="text/css">
       ...
       td.wb               {border-width:1px; border-style:solid; text-align:center;font-size:0.8em}
          td.wbs               {border-width:1px; border-style:solid; text-align:center;font-size:0.6em}
       ...
       td.ul                  {border-width:1px;border-style: none none solid none}
       td.xverticaltext      {writing-mode: tb-rl;filter: flipv fliph;}
       td.verticaltext     {layout-flow: vertical-ideographic;;font-size:0.6em}
    </STYLE>
  <body>
      <table width="100%">
                <tr> 
    ...
    <tr>
        <td>         
         <table class="wb" width =" 100%">
            <tr>
              <td align="left" > Administrative County  of</td><td class="input">   <xsl:value-of select="county"/></td>
    ...
    <tr>
          ...
          <xsl:for-each select="/certificate/people/person">
            <tr  height="24">
              ...
              <td class="input"><xsl:value-of select="occupation"/></td>
               <td class="input"><xsl:value-of select="employer"/></td>
               <td class="input"><xsl:value-of select="employed"/></td>
               <td class="input"><xsl:value-of select="neitherEmployernorEmployed"/></td>
      ...
      <td>
           <table class="wb" width =" 100%">
            <tr>
              <td align="left" > PRO reference</td><td class="input">   <xsl:value-of select="proReference"/></td><td width="50%"/>
              </tr>
         </table>
                  </td>
    </tr>
